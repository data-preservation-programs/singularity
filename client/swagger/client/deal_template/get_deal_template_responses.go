...
func (o *GetDealTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /deal-schedule-template/{idOrName}] GetDealTemplate", response, response.Code())
	}
}
...
func (o *GetDealTemplateOK) Error() string {
	...
	return fmt.Sprintf("[GET /deal-schedule-template/{idOrName}][%d] getDealTemplateOK %s", 200, payload)
}
...
func (o *GetDealTemplateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deal-schedule-template/{idOrName}][%d] getDealTemplateBadRequest %s", 400, payload)
}
...
func (o *GetDealTemplateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deal-schedule-template/{idOrName}][%d] getDealTemplateNotFound %s", 404, payload)
}
...
func (o *GetDealTemplateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /deal-schedule-template/{idOrName}][%d] getDealTemplateInternalServerError %s", 500, payload)
}
