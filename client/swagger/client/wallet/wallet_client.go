...
type ClientService interface {
	...
	GetWalletBalance(params *GetWalletBalanceParams, opts ...ClientOption) (*GetWalletBalanceOK, error)
	...
	UpdateWallet(params *UpdateWalletParams, opts ...ClientOption) (*UpdateWalletOK, error)
...
/*
GetWalletBalance gets wallet f i l and f i l balance

Retrieves the FIL balance and FIL+ datacap balance for a specific wallet address
*/
func (a *Client) GetWalletBalance(params *GetWalletBalanceParams, opts ...ClientOption) (*GetWalletBalanceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetWalletBalanceParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetWalletBalance",
		Method:             "GET",
		PathPattern:        "/wallet/{address}/balance",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetWalletBalanceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*GetWalletBalanceOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetWalletBalance: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) UpdateWallet(params *UpdateWalletParams, opts ...ClientOption) (*UpdateWalletOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	op := &runtime.ClientOperation{
		ID:                 "UpdateWallet",
		Method:             "PATCH",
		PathPattern:        "/wallet/{address}/update",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
