...
func (o *CreateDealTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /deal-template] CreateDealTemplate", response, response.Code())
	}
}
...
func (o *CreateDealTemplateOK) Error() string {
	...
	return fmt.Sprintf("[POST /deal-template][%d] createDealTemplateOK %s", 200, payload)
}
...
func (o *CreateDealTemplateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /deal-template][%d] createDealTemplateBadRequest %s", 400, payload)
}
...
func (o *CreateDealTemplateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /deal-template][%d] createDealTemplateInternalServerError %s", 500, payload)
}
