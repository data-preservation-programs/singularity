...
func (o *UpdateDealTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /deal-schedule-template/{idOrName}] UpdateDealTemplate", response, response.Code())
	}
}
...
func (o *UpdateDealTemplateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /deal-schedule-template/{idOrName}][%d] updateDealTemplateOK %s", 200, payload)
}
...
func (o *UpdateDealTemplateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /deal-schedule-template/{idOrName}][%d] updateDealTemplateBadRequest %s", 400, payload)
}
...
func (o *UpdateDealTemplateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /deal-schedule-template/{idOrName}][%d] updateDealTemplateNotFound %s", 404, payload)
}
...
func (o *UpdateDealTemplateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /deal-schedule-template/{idOrName}][%d] updateDealTemplateInternalServerError %s", 500, payload)
}
