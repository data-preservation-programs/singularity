...
// NewPostStorageSeafileParams creates a new PostStorageSeafileParams object,
...
func NewPostStorageSeafileParams() *PostStorageSeafileParams {
	return &PostStorageSeafileParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostStorageSeafileParamsWithTimeout creates a new PostStorageSeafileParams object
...
// NewPostStorageSeafileParamsWithContext creates a new PostStorageSeafileParams object
...
// NewPostStorageSeafileParamsWithHTTPClient creates a new PostStorageSeafileParams object
...
func (o *PostStorageSeafileParams) WithDefaults() *PostStorageSeafileParams {
	o.SetDefaults()
	return o
}
...
func (o *PostStorageSeafileParams) WithTimeout(timeout time.Duration) *PostStorageSeafileParams {
...
func (o *PostStorageSeafileParams) WithContext(ctx context.Context) *PostStorageSeafileParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostStorageSeafileParams) WithRequest(request *models.StorageCreateSeafileStorageRequest) *PostStorageSeafileParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post storage seafile params
func (o *PostStorageSeafileParams) SetRequest(request *models.StorageCreateSeafileStorageRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostStorageSeafileParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
