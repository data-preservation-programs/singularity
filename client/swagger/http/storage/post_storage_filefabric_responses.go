...
func (o *PostStorageFilefabricReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostStorageFilefabricOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewPostStorageFilefabricBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewPostStorageFilefabricInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /storage/filefabric] PostStorageFilefabric", response, response.Code())
	}
}
...
func NewPostStorageFilefabricOK() *PostStorageFilefabricOK {
	return &PostStorageFilefabricOK{}
}
...
func (o *PostStorageFilefabricOK) Error() string {
	return fmt.Sprintf("[POST /storage/filefabric][%d] postStorageFilefabricOK  %+v", 200, o.Payload)
}
...
func (o *PostStorageFilefabricOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostStorageFilefabricBadRequest() *PostStorageFilefabricBadRequest {
	return &PostStorageFilefabricBadRequest{}
}
...
func (o *PostStorageFilefabricBadRequest) Code() int {
	return 400
}

func (o *PostStorageFilefabricBadRequest) Error() string {
	return fmt.Sprintf("[POST /storage/filefabric][%d] postStorageFilefabricBadRequest  %+v", 400, o.Payload)
}

func (o *PostStorageFilefabricBadRequest) String() string {
	return fmt.Sprintf("[POST /storage/filefabric][%d] postStorageFilefabricBadRequest  %+v", 400, o.Payload)
}

func (o *PostStorageFilefabricBadRequest) GetPayload() *models.APIHTTPError {
	return o.Payload
}

func (o *PostStorageFilefabricBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostStorageFilefabricInternalServerError() *PostStorageFilefabricInternalServerError {
	return &PostStorageFilefabricInternalServerError{}
}
...
func (o *PostStorageFilefabricInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post storage filefabric internal server error response has a 3xx status code
func (o *PostStorageFilefabricInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post storage filefabric internal server error response has a 4xx status code
func (o *PostStorageFilefabricInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this post storage filefabric internal server error response has a 5xx status code
func (o *PostStorageFilefabricInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this post storage filefabric internal server error response a status code equal to that given
func (o *PostStorageFilefabricInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the post storage filefabric internal server error response
func (o *PostStorageFilefabricInternalServerError) Code() int {
	return 500
}

func (o *PostStorageFilefabricInternalServerError) Error() string {
	return fmt.Sprintf("[POST /storage/filefabric][%d] postStorageFilefabricInternalServerError  %+v", 500, o.Payload)
}

func (o *PostStorageFilefabricInternalServerError) String() string {
	return fmt.Sprintf("[POST /storage/filefabric][%d] postStorageFilefabricInternalServerError  %+v", 500, o.Payload)
}

func (o *PostStorageFilefabricInternalServerError) GetPayload() *models.APIHTTPError {
	return o.Payload
}

func (o *PostStorageFilefabricInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
