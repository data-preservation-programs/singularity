...
// NewPostStorageFilefabricParams creates a new PostStorageFilefabricParams object,
...
func NewPostStorageFilefabricParams() *PostStorageFilefabricParams {
	return &PostStorageFilefabricParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostStorageFilefabricParamsWithTimeout creates a new PostStorageFilefabricParams object
...
// NewPostStorageFilefabricParamsWithContext creates a new PostStorageFilefabricParams object
...
// NewPostStorageFilefabricParamsWithHTTPClient creates a new PostStorageFilefabricParams object
...
func (o *PostStorageFilefabricParams) WithDefaults() *PostStorageFilefabricParams {
	o.SetDefaults()
	return o
}
...
func (o *PostStorageFilefabricParams) WithTimeout(timeout time.Duration) *PostStorageFilefabricParams {
...
func (o *PostStorageFilefabricParams) WithContext(ctx context.Context) *PostStorageFilefabricParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostStorageFilefabricParams) WithHTTPClient(client *http.Client) *PostStorageFilefabricParams {
...
func (o *PostStorageFilefabricParams) WithRequest(request *models.StorageCreateFilefabricStorageRequest) *PostStorageFilefabricParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post storage filefabric params
func (o *PostStorageFilefabricParams) SetRequest(request *models.StorageCreateFilefabricStorageRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostStorageFilefabricParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
