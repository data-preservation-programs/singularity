...
func (o *CreateMegaStorageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateMegaStorageOK) Error() string {
	...
	return fmt.Sprintf("[POST /storage/mega][%d] createMegaStorageOK %s", 200, payload)
}
...
func (o *CreateMegaStorageBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /storage/mega][%d] createMegaStorageBadRequest %s", 400, payload)
}
...
func (o *CreateMegaStorageInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /storage/mega][%d] createMegaStorageInternalServerError %s", 500, payload)
}
