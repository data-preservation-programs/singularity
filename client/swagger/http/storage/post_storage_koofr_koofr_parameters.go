...
// NewPostStorageKoofrKoofrParams creates a new PostStorageKoofrKoofrParams object,
...
func NewPostStorageKoofrKoofrParams() *PostStorageKoofrKoofrParams {
	return &PostStorageKoofrKoofrParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostStorageKoofrKoofrParamsWithTimeout creates a new PostStorageKoofrKoofrParams object
...
// NewPostStorageKoofrKoofrParamsWithContext creates a new PostStorageKoofrKoofrParams object
...
// NewPostStorageKoofrKoofrParamsWithHTTPClient creates a new PostStorageKoofrKoofrParams object
...
func (o *PostStorageKoofrKoofrParams) WithDefaults() *PostStorageKoofrKoofrParams {
	o.SetDefaults()
	return o
}
...
func (o *PostStorageKoofrKoofrParams) WithTimeout(timeout time.Duration) *PostStorageKoofrKoofrParams {
...
func (o *PostStorageKoofrKoofrParams) WithContext(ctx context.Context) *PostStorageKoofrKoofrParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostStorageKoofrKoofrParams) WithHTTPClient(client *http.Client) *PostStorageKoofrKoofrParams {
...
func (o *PostStorageKoofrKoofrParams) WithRequest(request *models.StorageCreateKoofrKoofrStorageRequest) *PostStorageKoofrKoofrParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post storage koofr koofr params
func (o *PostStorageKoofrKoofrParams) SetRequest(request *models.StorageCreateKoofrKoofrStorageRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostStorageKoofrKoofrParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
