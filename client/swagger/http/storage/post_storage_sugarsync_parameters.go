...
// NewPostStorageSugarsyncParams creates a new PostStorageSugarsyncParams object,
...
func NewPostStorageSugarsyncParams() *PostStorageSugarsyncParams {
	return &PostStorageSugarsyncParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostStorageSugarsyncParamsWithTimeout creates a new PostStorageSugarsyncParams object
...
// NewPostStorageSugarsyncParamsWithContext creates a new PostStorageSugarsyncParams object
...
// NewPostStorageSugarsyncParamsWithHTTPClient creates a new PostStorageSugarsyncParams object
...
func (o *PostStorageSugarsyncParams) WithDefaults() *PostStorageSugarsyncParams {
	o.SetDefaults()
	return o
}
...
func (o *PostStorageSugarsyncParams) WithTimeout(timeout time.Duration) *PostStorageSugarsyncParams {
...
func (o *PostStorageSugarsyncParams) WithContext(ctx context.Context) *PostStorageSugarsyncParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostStorageSugarsyncParams) WithHTTPClient(client *http.Client) *PostStorageSugarsyncParams {
...
func (o *PostStorageSugarsyncParams) WithRequest(request *models.StorageCreateSugarsyncStorageRequest) *PostStorageSugarsyncParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post storage sugarsync params
func (o *PostStorageSugarsyncParams) SetRequest(request *models.StorageCreateSugarsyncStorageRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostStorageSugarsyncParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
