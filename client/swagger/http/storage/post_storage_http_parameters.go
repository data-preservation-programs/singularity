...
// NewPostStorageHTTPParams creates a new PostStorageHTTPParams object,
...
func NewPostStorageHTTPParams() *PostStorageHTTPParams {
	return &PostStorageHTTPParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostStorageHTTPParamsWithTimeout creates a new PostStorageHTTPParams object
...
// NewPostStorageHTTPParamsWithContext creates a new PostStorageHTTPParams object
...
// NewPostStorageHTTPParamsWithHTTPClient creates a new PostStorageHTTPParams object
...
func (o *PostStorageHTTPParams) WithContext(ctx context.Context) *PostStorageHTTPParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostStorageHTTPParams) WithRequest(request *models.StorageCreateHTTPStorageRequest) *PostStorageHTTPParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post storage HTTP params
func (o *PostStorageHTTPParams) SetRequest(request *models.StorageCreateHTTPStorageRequest) {
	o.Request = request
}
