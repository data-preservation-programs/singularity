...
func (o *PostPreparationIDOutputNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostPreparationIDOutputNameOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewPostPreparationIDOutputNameBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewPostPreparationIDOutputNameInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /preparation/{id}/output/{name}] PostPreparationIDOutputName", response, response.Code())
	}
}
...
func NewPostPreparationIDOutputNameOK() *PostPreparationIDOutputNameOK {
	return &PostPreparationIDOutputNameOK{}
}
...
func (o *PostPreparationIDOutputNameOK) Error() string {
	return fmt.Sprintf("[POST /preparation/{id}/output/{name}][%d] postPreparationIdOutputNameOK  %+v", 200, o.Payload)
}
...
func (o *PostPreparationIDOutputNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostPreparationIDOutputNameBadRequest() *PostPreparationIDOutputNameBadRequest {
	return &PostPreparationIDOutputNameBadRequest{}
}
...
func (o *PostPreparationIDOutputNameBadRequest) Error() string {
	return fmt.Sprintf("[POST /preparation/{id}/output/{name}][%d] postPreparationIdOutputNameBadRequest  %+v", 400, o.Payload)
}
...
func (o *PostPreparationIDOutputNameBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostPreparationIDOutputNameInternalServerError() *PostPreparationIDOutputNameInternalServerError {
	return &PostPreparationIDOutputNameInternalServerError{}
}
...
func (o *PostPreparationIDOutputNameInternalServerError) Error() string {
	return fmt.Sprintf("[POST /preparation/{id}/output/{name}][%d] postPreparationIdOutputNameInternalServerError  %+v", 500, o.Payload)
}
...
func (o *PostPreparationIDOutputNameInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
