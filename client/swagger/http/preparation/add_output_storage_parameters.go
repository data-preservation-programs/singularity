...
// NewAddOutputStorageParams creates a new AddOutputStorageParams object,
...
func NewAddOutputStorageParams() *AddOutputStorageParams {
	return &AddOutputStorageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewAddOutputStorageParamsWithTimeout creates a new AddOutputStorageParams object
...
// NewAddOutputStorageParamsWithContext creates a new AddOutputStorageParams object
...
// NewAddOutputStorageParamsWithHTTPClient creates a new AddOutputStorageParams object
...
func (o *AddOutputStorageParams) WithDefaults() *AddOutputStorageParams {
	o.SetDefaults()
	return o
}
...
func (o *AddOutputStorageParams) WithTimeout(timeout time.Duration) *AddOutputStorageParams {
...
func (o *AddOutputStorageParams) WithContext(ctx context.Context) *AddOutputStorageParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AddOutputStorageParams) WithID(id string) *AddOutputStorageParams {
	o.SetID(id)
	return o
}
...
func (o *AddOutputStorageParams) WithName(name string) *AddOutputStorageParams {
	o.SetName(name)
	return o
}
...
func (o *AddOutputStorageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
