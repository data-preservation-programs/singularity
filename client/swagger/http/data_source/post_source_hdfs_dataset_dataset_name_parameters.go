...
// NewPostSourceHdfsDatasetDatasetNameParams creates a new PostSourceHdfsDatasetDatasetNameParams object,
...
func NewPostSourceHdfsDatasetDatasetNameParams() *PostSourceHdfsDatasetDatasetNameParams {
	return &PostSourceHdfsDatasetDatasetNameParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostSourceHdfsDatasetDatasetNameParamsWithTimeout creates a new PostSourceHdfsDatasetDatasetNameParams object
...
// NewPostSourceHdfsDatasetDatasetNameParamsWithContext creates a new PostSourceHdfsDatasetDatasetNameParams object
...
// NewPostSourceHdfsDatasetDatasetNameParamsWithHTTPClient creates a new PostSourceHdfsDatasetDatasetNameParams object
...
func (o *PostSourceHdfsDatasetDatasetNameParams) WithDefaults() *PostSourceHdfsDatasetDatasetNameParams {
	o.SetDefaults()
	return o
}
...
func (o *PostSourceHdfsDatasetDatasetNameParams) WithTimeout(timeout time.Duration) *PostSourceHdfsDatasetDatasetNameParams {
...
func (o *PostSourceHdfsDatasetDatasetNameParams) WithContext(ctx context.Context) *PostSourceHdfsDatasetDatasetNameParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post source hdfs dataset dataset name params
func (o *PostSourceHdfsDatasetDatasetNameParams) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *PostSourceHdfsDatasetDatasetNameParams) WithDatasetName(datasetName string) *PostSourceHdfsDatasetDatasetNameParams {
...
func (o *PostSourceHdfsDatasetDatasetNameParams) SetRequest(request *models.DatasourceHdfsRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostSourceHdfsDatasetDatasetNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
