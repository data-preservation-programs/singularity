...
// NewPostSourceSftpDatasetDatasetNameParams creates a new PostSourceSftpDatasetDatasetNameParams object,
...
func NewPostSourceSftpDatasetDatasetNameParams() *PostSourceSftpDatasetDatasetNameParams {
	return &PostSourceSftpDatasetDatasetNameParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostSourceSftpDatasetDatasetNameParamsWithTimeout creates a new PostSourceSftpDatasetDatasetNameParams object
...
// NewPostSourceSftpDatasetDatasetNameParamsWithContext creates a new PostSourceSftpDatasetDatasetNameParams object
...
// NewPostSourceSftpDatasetDatasetNameParamsWithHTTPClient creates a new PostSourceSftpDatasetDatasetNameParams object
...
func (o *PostSourceSftpDatasetDatasetNameParams) WithDefaults() *PostSourceSftpDatasetDatasetNameParams {
	o.SetDefaults()
	return o
}
...
func (o *PostSourceSftpDatasetDatasetNameParams) WithTimeout(timeout time.Duration) *PostSourceSftpDatasetDatasetNameParams {
...
func (o *PostSourceSftpDatasetDatasetNameParams) WithContext(ctx context.Context) *PostSourceSftpDatasetDatasetNameParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post source sftp dataset dataset name params
func (o *PostSourceSftpDatasetDatasetNameParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the post source sftp dataset dataset name params
func (o *PostSourceSftpDatasetDatasetNameParams) WithHTTPClient(client *http.Client) *PostSourceSftpDatasetDatasetNameParams {
...
func (o *PostSourceSftpDatasetDatasetNameParams) WithDatasetName(datasetName string) *PostSourceSftpDatasetDatasetNameParams {
...
func (o *PostSourceSftpDatasetDatasetNameParams) WithRequest(request *models.DatasourceSftpRequest) *PostSourceSftpDatasetDatasetNameParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post source sftp dataset dataset name params
func (o *PostSourceSftpDatasetDatasetNameParams) SetRequest(request *models.DatasourceSftpRequest) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PostSourceSftpDatasetDatasetNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
