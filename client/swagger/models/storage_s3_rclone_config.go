...
// StorageS3RcloneConfig storage s3 rclone config
//
// swagger:model storage.s3RcloneConfig
type StorageS3RcloneConfig struct {
...
// Validate validates this storage s3 rclone config
func (m *StorageS3RcloneConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 rclone config based on context it is used
func (m *StorageS3RcloneConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3RcloneConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3RcloneConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3RcloneConfig
