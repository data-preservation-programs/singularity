...
// StorageS3RabataConfig storage s3 rabata config
//
// swagger:model storage.s3RabataConfig
type StorageS3RabataConfig struct {
...
// Validate validates this storage s3 rabata config
func (m *StorageS3RabataConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 rabata config based on context it is used
func (m *StorageS3RabataConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3RabataConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3RabataConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3RabataConfig
