...
// StorageS3ExabaConfig storage s3 exaba config
//
// swagger:model storage.s3ExabaConfig
type StorageS3ExabaConfig struct {
...
// Validate validates this storage s3 exaba config
func (m *StorageS3ExabaConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 exaba config based on context it is used
func (m *StorageS3ExabaConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3ExabaConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3ExabaConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3ExabaConfig
