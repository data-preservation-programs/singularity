...
// StorageS3ServercoreConfig storage s3 servercore config
//
// swagger:model storage.s3ServercoreConfig
type StorageS3ServercoreConfig struct {
...
// Validate validates this storage s3 servercore config
func (m *StorageS3ServercoreConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 servercore config based on context it is used
func (m *StorageS3ServercoreConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3ServercoreConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3ServercoreConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3ServercoreConfig
