...
// StorageS3MegaConfig storage s3 mega config
//
// swagger:model storage.s3MegaConfig
type StorageS3MegaConfig struct {
...
// Validate validates this storage s3 mega config
func (m *StorageS3MegaConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 mega config based on context it is used
func (m *StorageS3MegaConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3MegaConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3MegaConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3MegaConfig
