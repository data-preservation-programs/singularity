...
// StorageS3LeviiaConfig storage s3 leviia config
//
// swagger:model storage.s3LeviiaConfig
type StorageS3LeviiaConfig struct {
...
// Validate validates this storage s3 leviia config
func (m *StorageS3LeviiaConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 leviia config based on context it is used
func (m *StorageS3LeviiaConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3LeviiaConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3LeviiaConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3LeviiaConfig
