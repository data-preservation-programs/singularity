...
// StorageS3SynologyConfig storage s3 synology config
//
// swagger:model storage.s3SynologyConfig
type StorageS3SynologyConfig struct {
...
// Validate validates this storage s3 synology config
func (m *StorageS3SynologyConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 synology config based on context it is used
func (m *StorageS3SynologyConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3SynologyConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3SynologyConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3SynologyConfig
