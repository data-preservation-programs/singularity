...
// StorageS3FlashBladeConfig storage s3 flash blade config
//
// swagger:model storage.s3FlashBladeConfig
type StorageS3FlashBladeConfig struct {
...
// Validate validates this storage s3 flash blade config
func (m *StorageS3FlashBladeConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 flash blade config based on context it is used
func (m *StorageS3FlashBladeConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3FlashBladeConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3FlashBladeConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3FlashBladeConfig
