...
// StorageS3LinodeConfig storage s3 linode config
//
// swagger:model storage.s3LinodeConfig
type StorageS3LinodeConfig struct {
...
// Validate validates this storage s3 linode config
func (m *StorageS3LinodeConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 linode config based on context it is used
func (m *StorageS3LinodeConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3LinodeConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3LinodeConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3LinodeConfig
