...
// StorageS3CubbitConfig storage s3 cubbit config
//
// swagger:model storage.s3CubbitConfig
type StorageS3CubbitConfig struct {
...
// Validate validates this storage s3 cubbit config
func (m *StorageS3CubbitConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 cubbit config based on context it is used
func (m *StorageS3CubbitConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3CubbitConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3CubbitConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3CubbitConfig
