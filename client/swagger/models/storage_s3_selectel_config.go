...
// StorageS3SelectelConfig storage s3 selectel config
//
// swagger:model storage.s3SelectelConfig
type StorageS3SelectelConfig struct {
...
// Validate validates this storage s3 selectel config
func (m *StorageS3SelectelConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 selectel config based on context it is used
func (m *StorageS3SelectelConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3SelectelConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3SelectelConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3SelectelConfig
