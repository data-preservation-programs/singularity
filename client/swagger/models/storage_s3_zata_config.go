...
// StorageS3ZataConfig storage s3 zata config
//
// swagger:model storage.s3ZataConfig
type StorageS3ZataConfig struct {
...
// Validate validates this storage s3 zata config
func (m *StorageS3ZataConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 zata config based on context it is used
func (m *StorageS3ZataConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3ZataConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3ZataConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3ZataConfig
