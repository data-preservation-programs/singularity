...
// StorageS3BizflyCloudConfig storage s3 bizfly cloud config
//
// swagger:model storage.s3BizflyCloudConfig
type StorageS3BizflyCloudConfig struct {
...
// Validate validates this storage s3 bizfly cloud config
func (m *StorageS3BizflyCloudConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 bizfly cloud config based on context it is used
func (m *StorageS3BizflyCloudConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3BizflyCloudConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3BizflyCloudConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3BizflyCloudConfig
