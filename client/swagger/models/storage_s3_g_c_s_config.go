...
// StorageS3GCSConfig storage s3 g c s config
//
// swagger:model storage.s3GCSConfig
type StorageS3GCSConfig struct {
...
// Validate validates this storage s3 g c s config
func (m *StorageS3GCSConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 g c s config based on context it is used
func (m *StorageS3GCSConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3GCSConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3GCSConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3GCSConfig
