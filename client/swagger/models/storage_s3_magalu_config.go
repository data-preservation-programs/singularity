...
// StorageS3MagaluConfig storage s3 magalu config
//
// swagger:model storage.s3MagaluConfig
type StorageS3MagaluConfig struct {
...
// Validate validates this storage s3 magalu config
func (m *StorageS3MagaluConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 magalu config based on context it is used
func (m *StorageS3MagaluConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3MagaluConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3MagaluConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3MagaluConfig
