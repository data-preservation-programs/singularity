...
// StorageS3HetznerConfig storage s3 hetzner config
//
// swagger:model storage.s3HetznerConfig
type StorageS3HetznerConfig struct {
...
// Validate validates this storage s3 hetzner config
func (m *StorageS3HetznerConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 hetzner config based on context it is used
func (m *StorageS3HetznerConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3HetznerConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3HetznerConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3HetznerConfig
