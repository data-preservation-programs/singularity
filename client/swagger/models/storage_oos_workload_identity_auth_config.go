...
// StorageOosWorkloadIdentityAuthConfig storage oos workload identity auth config
//
// swagger:model storage.oosWorkload_identity_authConfig
type StorageOosWorkloadIdentityAuthConfig struct {
...
// Validate validates this storage oos workload identity auth config
func (m *StorageOosWorkloadIdentityAuthConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage oos workload identity auth config based on context it is used
func (m *StorageOosWorkloadIdentityAuthConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageOosWorkloadIdentityAuthConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageOosWorkloadIdentityAuthConfig) UnmarshalBinary(b []byte) error {
	var res StorageOosWorkloadIdentityAuthConfig
