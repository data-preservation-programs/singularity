...
// StorageS3OutscaleConfig storage s3 outscale config
//
// swagger:model storage.s3OutscaleConfig
type StorageS3OutscaleConfig struct {
...
// Validate validates this storage s3 outscale config
func (m *StorageS3OutscaleConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 outscale config based on context it is used
func (m *StorageS3OutscaleConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3OutscaleConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3OutscaleConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3OutscaleConfig
