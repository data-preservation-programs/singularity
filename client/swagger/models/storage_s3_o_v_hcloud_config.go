...
// StorageS3OVHcloudConfig storage s3 o v hcloud config
//
// swagger:model storage.s3OVHcloudConfig
type StorageS3OVHcloudConfig struct {
...
// Validate validates this storage s3 o v hcloud config
func (m *StorageS3OVHcloudConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 o v hcloud config based on context it is used
func (m *StorageS3OVHcloudConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3OVHcloudConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3OVHcloudConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3OVHcloudConfig
