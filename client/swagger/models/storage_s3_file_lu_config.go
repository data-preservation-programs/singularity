...
// StorageS3FileLuConfig storage s3 file lu config
//
// swagger:model storage.s3FileLuConfig
type StorageS3FileLuConfig struct {
...
// Validate validates this storage s3 file lu config
func (m *StorageS3FileLuConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 file lu config based on context it is used
func (m *StorageS3FileLuConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3FileLuConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3FileLuConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3FileLuConfig
