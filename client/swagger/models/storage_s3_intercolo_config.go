...
// StorageS3IntercoloConfig storage s3 intercolo config
//
// swagger:model storage.s3IntercoloConfig
type StorageS3IntercoloConfig struct {
...
// Validate validates this storage s3 intercolo config
func (m *StorageS3IntercoloConfig) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this storage s3 intercolo config based on context it is used
func (m *StorageS3IntercoloConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *StorageS3IntercoloConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StorageS3IntercoloConfig) UnmarshalBinary(b []byte) error {
	var res StorageS3IntercoloConfig
