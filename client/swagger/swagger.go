...
//go:generate go run github.com/go-swagger/go-swagger/cmd/swagger@v0.30.5 generate client -f ../../docs/swagger/swagger.json -t ../../ -c client/swagger/http -m client/swagger/models -a /client/swagger/operations --with-enum-ci
