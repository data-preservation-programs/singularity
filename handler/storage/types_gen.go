...
type AcdConfig struct {
	...
	UploadWaitPerGb   fs.Duration          `json:"uploadWaitPerGb" default:"3m0s"`           // Additional time per GiB to wait after a failed complete upload to see if it appears.
	TemplinkThreshold fs.SizeSuffix        `json:"templinkThreshold" default:"9Gi"`          // Files >= this size will be downloaded via their tempLink.
	Encoding          encoder.MultiEncoder `json:"encoding" default:"Slash,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type AzureblobConfig struct {
	...
	ChunkSize                  fs.SizeSuffix        `json:"chunkSize" default:"4Mi"`                                            // Upload chunk size.
	...
	MemoryPoolFlushTime        fs.Duration          `json:"memoryPoolFlushTime" default:"1m0s"`                                 // How often internal memory buffer pools will be flushed.
	MemoryPoolUseMmap          bool                 `json:"memoryPoolUseMmap" default:"false"`                                  // Whether to use mmap buffers in internal memory pool.
	Encoding                   encoder.MultiEncoder `json:"encoding" default:"Slash,BackSlash,Del,Ctl,RightPeriod,InvalidUtf8"` // The encoding for the backend.
...
type B2Config struct {
	...
	VersionAt            fs.Time              `json:"versionAt" default:"off"`                                    // Show file versions as they were at the specified time.
	HardDelete           bool                 `json:"hardDelete" default:"false"`                                 // Permanently delete files on remote removal, otherwise hide files.
	UploadCutoff         fs.SizeSuffix        `json:"uploadCutoff" default:"200Mi"`                               // Cutoff for switching to chunked upload.
	CopyCutoff           fs.SizeSuffix        `json:"copyCutoff" default:"4Gi"`                                   // Cutoff for switching to multipart copy.
	ChunkSize            fs.SizeSuffix        `json:"chunkSize" default:"96Mi"`                                   // Upload chunk size.
	...
	DownloadAuthDuration fs.Duration          `json:"downloadAuthDuration" default:"1w"`                          // Time before the authorization token will expire in s or suffix ms|s|m|h|d.
	MemoryPoolFlushTime  fs.Duration          `json:"memoryPoolFlushTime" default:"1m0s"`                         // How often internal memory buffer pools will be flushed.
	MemoryPoolUseMmap    bool                 `json:"memoryPoolUseMmap" default:"false"`                          // Whether to use mmap buffers in internal memory pool.
	Encoding             encoder.MultiEncoder `json:"encoding" default:"Slash,BackSlash,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type BoxConfig struct {
	...
	UploadCutoff  fs.SizeSuffix        `json:"uploadCutoff" default:"50Mi"`                                           // Cutoff for switching to multipart upload (>= 50 MiB).
	...
	Encoding      encoder.MultiEncoder `json:"encoding" default:"Slash,BackSlash,Del,Ctl,RightSpace,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type DriveConfig struct {
	...
	UploadCutoff              fs.SizeSuffix        `json:"uploadCutoff" default:"8Mi"`                 // Cutoff for switching to chunked upload.
	ChunkSize                 fs.SizeSuffix        `json:"chunkSize" default:"8Mi"`                    // Upload chunk size.
	...
	V2DownloadMinSize         fs.SizeSuffix        `json:"v2DownloadMinSize" default:"off"`            // If Object's are greater, use drive v2 API to download.
	PacerMinSleep             fs.Duration          `json:"pacerMinSleep" default:"100ms"`              // Minimum time to sleep between API calls.
	...
	Encoding                  encoder.MultiEncoder `json:"encoding" default:"InvalidUtf8"`             // The encoding for the backend.
}
...
type DropboxConfig struct {
	...
	AuthUrl            string               `json:"authUrl"`                                                           // Auth server URL.
	TokenUrl           string               `json:"tokenUrl"`                                                          // Token server url.
	ChunkSize          fs.SizeSuffix        `json:"chunkSize" default:"48Mi"`                                          // Upload chunk size (< 150Mi).
	...
	BatchTimeout       fs.Duration          `json:"batchTimeout" default:"0s"`                                         // Max time to allow an idle upload batch before uploading.
	BatchCommitTimeout fs.Duration          `json:"batchCommitTimeout" default:"10m0s"`                                // Max time to wait for a batch to finish committing
	Encoding           encoder.MultiEncoder `json:"encoding" default:"Slash,BackSlash,Del,RightSpace,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type FichierConfig struct {
	...
	Encoding       encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,SingleQuote,BackQuote,Dollar,BackSlash,Del,Ctl,LeftSpace,RightSpace,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type FilefabricConfig struct {
	...
	Encoding       encoder.MultiEncoder `json:"encoding" default:"Slash,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type FtpConfig struct {
	...
	IdleTimeout        fs.Duration          `json:"idleTimeout" default:"1m0s"`                                                       // Max time before closing idle connections.
	CloseTimeout       fs.Duration          `json:"closeTimeout" default:"1m0s"`                                                      // Maximum time to wait for a response to close.
	...
	ShutTimeout        fs.Duration          `json:"shutTimeout" default:"1m0s"`                                                       // Maximum time to wait for data connection closing status.
	AskPassword        bool                 `json:"askPassword" default:"false"`                                                      // Allow asking for FTP password when needed.
	Encoding           encoder.MultiEncoder `json:"encoding" default:"Slash,Del,Ctl,RightSpace,Dot" example:"Asterisk,Ctl,Dot,Slash"` // The encoding for the backend.
}
...
type GcsConfig struct {
	...
	Endpoint                  string               `json:"endpoint"`                                      // Endpoint for the service.
	Encoding                  encoder.MultiEncoder `json:"encoding" default:"Slash,CrLf,InvalidUtf8,Dot"` // The encoding for the backend.
...
type HdfsConfig struct {
	...
	Encoding               encoder.MultiEncoder `json:"encoding" default:"Slash,Colon,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type HidriveConfig struct {
	...
	ChunkSize                  fs.SizeSuffix        `json:"chunkSize" default:"48Mi"`                              // Chunksize for chunked uploads.
	UploadCutoff               fs.SizeSuffix        `json:"uploadCutoff" default:"96Mi"`                           // Cutoff/Threshold for chunked uploads.
	UploadConcurrency          int                  `json:"uploadConcurrency" default:"4"`                         // Concurrency for chunked uploads.
	Encoding                   encoder.MultiEncoder `json:"encoding" default:"Slash,Dot"`                          // The encoding for the backend.
}
...
type HttpConfig struct {
	...
	Headers fs.CommaSepList `json:"headers"`                 // Set HTTP headers for all transactions.
...
type InternetarchiveConfig struct {
	...
	WaitArchive     fs.Duration          `json:"waitArchive" default:"0s"`                                   // Timeout for waiting the server's processing tasks (specifically archive and book_op) to finish.
	Encoding        encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,CrLf,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type JottacloudConfig struct {
	Md5MemoryLimit    fs.SizeSuffix        `json:"md5MemoryLimit" default:"10Mi"`                                                                  // Files bigger than this will be cached on disk to calculate the MD5 if required.
	TrashedOnly       bool                 `json:"trashedOnly" default:"false"`                                                                    // Only show files that are in the trash.
	HardDelete        bool                 `json:"hardDelete" default:"false"`                                                                     // Delete files permanently rather than putting them into the trash.
	UploadResumeLimit fs.SizeSuffix        `json:"uploadResumeLimit" default:"10Mi"`                                                               // Files bigger than this can be resumed if the upload fail's.
	...
	Encoding          encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type MailruConfig struct {
	...
	SpeedupMaxDisk      fs.SizeSuffix        `json:"speedupMaxDisk" default:"3Gi" example:"0"`                                                                 // This option allows you to disable speedup (put by hash) for large files.
	SpeedupMaxMemory    fs.SizeSuffix        `json:"speedupMaxMemory" default:"32Mi" example:"0"`                                                              // Files larger than the size given below will always be hashed on disk.
	...
	Encoding            encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type OnedriveConfig struct {
	...
	ChunkSize               fs.SizeSuffix        `json:"chunkSize" default:"10Mi"`                                                                                                                                                                                                 // Chunk size to upload files with - must be multiple of 320k (327,680 bytes).
	...
	RootFolderId            string               `json:"rootFolderId"`                                                                                                                                                                                                             // ID of the root folder.
	AccessScopes            fs.SpaceSepList      `json:"accessScopes" default:"Files.Read Files.ReadWrite Files.Read.All Files.ReadWrite.All Sites.Read.All offline_access" example:"Files.Read Files.ReadWrite Files.Read.All Files.ReadWrite.All Sites.Read.All offline_access"` // Set scopes to be requested by rclone.
	...
	Encoding                encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Del,Ctl,LeftSpace,LeftTilde,RightSpace,RightPeriod,InvalidUtf8,Dot"`                                                                      // The encoding for the backend.
}
...
type OpendriveConfig struct {
	...
	Encoding  encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,LeftSpace,LeftCrLfHtVt,RightSpace,RightCrLfHtVt,InvalidUtf8,Dot"` // The encoding for the backend.
	ChunkSize fs.SizeSuffix        `json:"chunkSize" default:"10Mi"`                                                                                                                         // Files will be uploaded in chunks this size.
}
...
type OosEnv_authConfig struct {
	...
	UploadCutoff         fs.SizeSuffix        `json:"uploadCutoff" default:"200Mi"`                      // Cutoff for switching to chunked upload.
	ChunkSize            fs.SizeSuffix        `json:"chunkSize" default:"5Mi"`                           // Chunk size to use for uploading.
	UploadConcurrency    int                  `json:"uploadConcurrency" default:"10"`                    // Concurrency for multipart uploads.
	CopyCutoff           fs.SizeSuffix        `json:"copyCutoff" default:"4.656Gi"`                      // Cutoff for switching to multipart copy.
	CopyTimeout          fs.Duration          `json:"copyTimeout" default:"1m0s"`                        // Timeout for copy.
	DisableChecksum      bool                 `json:"disableChecksum" default:"false"`                   // Don't store MD5 checksum with object metadata.
	Encoding             encoder.MultiEncoder `json:"encoding" default:"Slash,InvalidUtf8,Dot"`          // The encoding for the backend.
...
type PremiumizemeConfig struct {
	...
	Encoding encoder.MultiEncoder `json:"encoding" default:"Slash,DoubleQuote,BackSlash,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type QingstorConfig struct {
	...
	UploadCutoff      fs.SizeSuffix        `json:"uploadCutoff" default:"200Mi"`             // Cutoff for switching to chunked upload.
	ChunkSize         fs.SizeSuffix        `json:"chunkSize" default:"4Mi"`                  // Chunk size to use for uploading.
	UploadConcurrency int                  `json:"uploadConcurrency" default:"1"`            // Concurrency for multipart uploads.
	Encoding          encoder.MultiEncoder `json:"encoding" default:"Slash,Ctl,InvalidUtf8"` // The encoding for the backend.
}
...
type S3AWSConfig struct {
	...
	ListUrlEncode         fs.Tristate          `json:"listUrlEncode" default:"unset"`            // Whether to url encode listings: true/false/unset
	NoCheckBucket         bool                 `json:"noCheckBucket" default:"false"`            // If set, don't attempt to check the bucket exists or create it.
	...
	DownloadUrl           string               `json:"downloadUrl"`                              // Custom endpoint for downloads.
	UseMultipartEtag      fs.Tristate          `json:"useMultipartEtag" default:"unset"`         // Whether to use ETag in multipart uploads for verification
	...
	VersionAt             fs.Time              `json:"versionAt" default:"off"`                  // Show file versions as they were at the specified time.
	Decompress            bool                 `json:"decompress" default:"false"`               // If set this will decompress gzip encoded objects.
	MightGzip             fs.Tristate          `json:"mightGzip" default:"unset"`                // Set this if the backend might gzip objects.
...
type SeafileConfig struct {
	...
	Encoding      encoder.MultiEncoder `json:"encoding" default:"Slash,DoubleQuote,BackSlash,Ctl,InvalidUtf8"` // The encoding for the backend.
}
...
type SftpConfig struct {
	...
	IdleTimeout             fs.Duration     `json:"idleTimeout" default:"1m0s"`                        // Max time before closing idle connections.
	ChunkSize               fs.SizeSuffix   `json:"chunkSize" default:"32Ki"`                          // Upload and download chunk size.
	Concurrency             int             `json:"concurrency" default:"64"`                          // The maximum number of outstanding requests for one file
	SetEnv                  fs.SpaceSepList `json:"setEnv"`                                            // Environment variables to pass to sftp and commands
	Ciphers                 fs.SpaceSepList `json:"ciphers"`                                           // Space separated list of ciphers to be used for session encryption, ordered by preference.
	KeyExchange             fs.SpaceSepList `json:"keyExchange"`                                       // Space separated list of key exchange algorithms, ordered by preference.
	Macs                    fs.SpaceSepList `json:"macs"`                                              // Space separated list of MACs (message authentication code) algorithms, ordered by preference.
}
...
type SharefileConfig struct {
	UploadCutoff fs.SizeSuffix        `json:"uploadCutoff" default:"128Mi"`                                                                                                                     // Cutoff for switching to multipart upload.
	RootFolderId string               `json:"rootFolderId" example:""`                                                                                                                          // ID of the root folder.
	ChunkSize    fs.SizeSuffix        `json:"chunkSize" default:"64Mi"`                                                                                                                         // Upload chunk size.
	Endpoint     string               `json:"endpoint"`                                                                                                                                         // Endpoint for API calls.
	Encoding     encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Ctl,LeftSpace,LeftPeriod,RightSpace,RightPeriod,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type SiaConfig struct {
	...
	Encoding    encoder.MultiEncoder `json:"encoding" default:"Slash,Question,Hash,Percent,Del,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type SmbConfig struct {
	...
	Encoding         encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Ctl,RightSpace,RightPeriod,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type SugarsyncConfig struct {
	...
	Encoding            encoder.MultiEncoder `json:"encoding" default:"Slash,Ctl,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type SwiftConfig struct {
	...
	ChunkSize                   fs.SizeSuffix        `json:"chunkSize" default:"5Gi"`                                 // Above this size files will be chunked into a _segments container.
	...
	Encoding                    encoder.MultiEncoder `json:"encoding" default:"Slash,InvalidUtf8"`                    // The encoding for the backend.
}
...
type UptoboxConfig struct {
	...
	Encoding    encoder.MultiEncoder `json:"encoding" default:"Slash,LtGt,DoubleQuote,BackQuote,Del,Ctl,LeftSpace,InvalidUtf8,Dot"` // The encoding for the backend.
}
...
type ZohoConfig struct {
	...
	Encoding     encoder.MultiEncoder `json:"encoding" default:"Del,Ctl,InvalidUtf8"` // The encoding for the backend.
}
