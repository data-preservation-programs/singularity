...
type Source struct {
	...
	RootDirectory        *Directory `gorm:"foreignKey:RootDirectoryID;constraint:OnDelete:SET NULL" json:"rootDirectory,omitempty" swaggerignore:"true"`
...
type Chunk struct {
	...
	Car             *Car       `gorm:"constraint:OnDelete:CASCADE" json:"car,omitempty"`
}
