...
func scheduleTargetFlags() []cli.Flag {
	return []cli.Flag{
		&cli.StringFlag{
			Name:     "preparation",
...
func scheduleCreateFlags(includeDealType bool) []cli.Flag {
	flags := make([]cli.Flag, 0, 19)
	if includeDealType {
...
func allowedPieceCIDsFromContext(c *cli.Context) ([]string, error) {
