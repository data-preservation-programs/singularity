# Update an SP Pool's default deal parameters

{% code fullWidth="true" %}
```
NAME:
   singularity deal sp-pool update - Update an SP Pool's default deal parameters

USAGE:
   singularity deal sp-pool update [command options] <pool_id>
