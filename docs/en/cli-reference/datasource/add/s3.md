...
DESCRIPTION:
   ...
   --s3-region
      ...
      [Provider] - Ceph, IBMCOS, StackPath, Minio
         Region to connect to.
   ...
   --s3-acl
      [Provider] - TencentCOS, AWS, Scaleway, IONOS, ArvanCloud, Liara, Alibaba, ChinaMobile, Ceph, HuaweiOBS, Qiniu, IBMCOS, StackPath, RackCorp, Minio
