...
DESCRIPTION:
   ...
   --s3-acl
      [Provider] - ChinaMobile, Ceph, RackCorp, HuaweiOBS, Liara, StackPath, AWS, Scaleway, IBMCOS, Alibaba, TencentCOS, Minio, Qiniu, IONOS, ArvanCloud
   ...
   --s3-region
      ...
      [Provider] - Minio, Ceph, StackPath, IBMCOS
         Region to connect to.
