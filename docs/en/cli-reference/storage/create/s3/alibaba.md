...
USAGE:
   singularity storage create s3 alibaba [command options] <name> <path>
...
OPTIONS:
   ...
   --storage_class value      The storage class to use when storing new objects in OSS. [$STORAGE_CLASS]
