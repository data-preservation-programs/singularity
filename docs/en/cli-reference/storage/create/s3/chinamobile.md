...
USAGE:
   singularity storage create s3 chinamobile [command options] <name> <path>
...
OPTIONS:
   ...
   --help, -h                      show help
   --location_constraint value     Location constraint - must match endpoint. [$LOCATION_CONSTRAINT]
   ...
   --storage_class value           The storage class to use when storing new objects in ChinaMobile. [$STORAGE_CLASS]
