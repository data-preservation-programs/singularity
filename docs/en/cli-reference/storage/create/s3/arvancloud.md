...
USAGE:
   singularity storage create s3 arvancloud [command options] <name> <path>
...
OPTIONS:
   ...
   --storage_class value        The storage class to use when storing new objects in ArvanCloud. [$STORAGE_CLASS]
