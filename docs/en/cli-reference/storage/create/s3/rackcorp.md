...
USAGE:
   singularity storage create s3 rackcorp [command options] <name> <path>
...
OPTIONS:
   ...
   --help, -h                   show help
   --location_constraint value  Location constraint - the location where your bucket will be located and your data stored. [$LOCATION_CONSTRAINT]
