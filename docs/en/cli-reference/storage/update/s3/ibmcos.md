...
USAGE:
   singularity storage update s3 ibmcos [command options] <name>
...
OPTIONS:
   ...
   --help, -h                   show help
   --location_constraint value  Location constraint - must match endpoint when using IBM Cloud Public. [$LOCATION_CONSTRAINT]
