...
```
NAME:
   singularity storage update s3 leviia - Leviia Object Storage

USAGE:
   singularity storage update s3 leviia [command options] <name|id>
...
DESCRIPTION:
   ...
   --endpoint
      ...
      Examples:
         | s3.leviia.com | The default endpoint
         |               | Leviia
