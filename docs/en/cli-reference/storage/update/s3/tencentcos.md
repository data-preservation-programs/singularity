...
USAGE:
   singularity storage update s3 tencentcos [command options] <name>
...
OPTIONS:
   ...
   --storage_class value      The storage class to use when storing new objects in Tencent COS. [$STORAGE_CLASS]
