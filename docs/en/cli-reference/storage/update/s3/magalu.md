...
```
NAME:
   singularity storage update s3 magalu - Magalu Object Storage

USAGE:
   singularity storage update s3 magalu [command options] <name|id>
...
DESCRIPTION:
   ...
   --endpoint
      ...
      Examples:
         | br-se1.magaluobjects.com | Magalu BR Southeast 1 endpoint
         | br-ne1.magaluobjects.com | Magalu BR Northeast 1 endpoint
   ...
   --storage-class
      The storage class to use when storing new objects in Magalu.
...
OPTIONS:
   ...
   --storage-class value      The storage class to use when storing new objects in Magalu. [$STORAGE_CLASS]
