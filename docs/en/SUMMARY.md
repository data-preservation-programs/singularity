...
* [Deal](cli-reference/deal/README.md)
  ...
  * [Sp Pool](cli-reference/deal/sp-pool/README.md)
    * [Create](cli-reference/deal/sp-pool/create.md)
    * [List](cli-reference/deal/sp-pool/list.md)
    * [Get](cli-reference/deal/sp-pool/get.md)
    * [Update](cli-reference/deal/sp-pool/update.md)
    * [Remove](cli-reference/deal/sp-pool/remove.md)
    * [Pause](cli-reference/deal/sp-pool/pause.md)
    * [Resume](cli-reference/deal/sp-pool/resume.md)
    * [Add Provider](cli-reference/deal/sp-pool/add-provider.md)
    * [Remove Provider](cli-reference/deal/sp-pool/remove-provider.md)
    * [Add Preparation](cli-reference/deal/sp-pool/add-preparation.md)
    * [Remove Preparation](cli-reference/deal/sp-pool/remove-preparation.md)
...
* [SP Pool](web-api-reference/sp-pool.md)
