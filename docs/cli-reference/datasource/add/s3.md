...
DESCRIPTION:
   ...
   --s3-region
      ...
      [Provider] - IBMCOS, StackPath, Minio, Ceph
         Region to connect to.
   ...
   --s3-endpoint
      ...
      [Provider] - Minio, Cloudflare, Ceph
         Endpoint for S3 API.
   ...
   --s3-acl
      [Provider] - Ceph, Alibaba, StackPath, Minio, HuaweiOBS, IONOS, ChinaMobile, IBMCOS, Scaleway, ArvanCloud, TencentCOS, AWS, RackCorp, Qiniu, Liara
