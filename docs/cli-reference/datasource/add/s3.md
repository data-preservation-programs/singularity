...
DESCRIPTION:
   ...
   --s3-acl
      [Provider] - Alibaba, TencentCOS, RackCorp, IBMCOS, AWS, Scaleway, ChinaMobile, Ceph, Minio, HuaweiOBS, Qiniu, ArvanCloud, IONOS, Liara, StackPath
   ...
   --s3-endpoint
      ...
      [Provider] - Cloudflare, Ceph, Minio
         Endpoint for S3 API.
   ...
   --s3-region
      ...
      [Provider] - Ceph, Minio, StackPath, IBMCOS
         Region to connect to.
