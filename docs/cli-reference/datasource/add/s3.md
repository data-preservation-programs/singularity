...
DESCRIPTION:
   ...
   --s3-acl
      [Provider] - AWS, ArvanCloud, Alibaba, StackPath, Ceph, Scaleway, ChinaMobile, Liara, TencentCOS, RackCorp, Qiniu, Minio, HuaweiOBS, IONOS, IBMCOS
   ...
   --s3-region
      ...
      [Provider] - StackPath, Ceph, Minio, IBMCOS
         Region to connect to.
