...
DESCRIPTION:
   ...
   --s3-acl
      [Provider] - RackCorp, HuaweiOBS, IONOS, ArvanCloud, Liara, StackPath, AWS, ChinaMobile, Qiniu, Alibaba, Scaleway, IBMCOS, TencentCOS, Ceph, Minio
   ...
   --s3-region
      ...
      [Provider] - IBMCOS, Ceph, Minio, StackPath
         Region to connect to.
