    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sppool.CreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sp-pool/{id}": {
            "get": {
                ...
                "operationId": "GetSPPool",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "SP Pool ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sppool.UpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sp-pool/{id}/preparation": {
            "post": {
                ...
                "operationId": "AddSPPoolPreparation",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "SP Pool ID",
                    ...
                    {
                        "description": "AddPreparationRequest",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sppool.AddPreparationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.SPPoolPreparation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sp-pool/{id}/preparation/{preparation_id}": {
            "delete": {
                ...
                "operationId": "RemoveSPPoolPreparation",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "SP Pool ID",
                    ...
                    {
                        "type": "integer",
                        "description": "Pool Preparation ID",
                        "name": "preparation_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/sp-pool/{id}/provider": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "AddProviderRequest",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sppool.AddProviderRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.SPPoolProvider"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/sp-pool/{id}/provider/{provider_id}": {
            "delete": {
                ...
                "operationId": "RemoveSPPoolProvider",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "SP Pool ID",
    ...
    "definitions": {
        ...
        "model.SPPool": {
            ...
            "properties": {
                ...
                "state": {
                    "$ref": "#/definitions/model.SPPoolState"
                },
                "updatedAt": {
                    "type": "string"
                },
                "urlTemplate": {
                    "description": "Default deal parameters inherited by all generated schedules.",
                    "type": "string"
                },
                "verified": {
                    "type": "boolean"
        ...
        "model.SPPoolProvider": {
            ...
            "properties": {
                ...
                "policy": {
                    "description": "Policy: how many schedules of each deal type per preparation.\nExample: {\"market\": 1, \"pdp\": 1} means 1 market + 1 PDP schedule per preparation.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.ReplicationPolicy"
                        }
                    ]
                },
                "poolId": {
                ...
                "urlTemplate": {
                    "description": "Optional per-provider URL template override (nil = inherit from pool).",
                    "type": "string"
                }
            }
        },
        ...
        "sppool.AddProviderRequest": {
            "type": "object",
            "properties": {
                "policy": {
                    "description": "Replication policy, e.g. {\"market\": 1, \"pdp\": 1}",
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.ReplicationPolicy"
                        }
                ...
                "urlTemplate": {
                    "description": "Optional per-provider URL template override",
                    "type": "string"
                }
            }
        },
        "sppool.CreateRequest": {
            "type": "object",
            "properties": {
                "duration": {
                    "type": "string",
                ...
                "name": {
                    "description": "Pool name (must be unique)",
                    "type": "string"
                },
                "notes": {
                    "description": "Notes",
                ...
                "urlTemplate": {
                    "description": "URL template with PIECE_CID placeholder",
                    "type": "string"
                },
                "verified": {
                    "type": "boolean",
